...
# Uninstall services
cmd /c $loc\Integration\UnInstallElvizWCFPublishingService.cmd
cmd /c $loc\Integration\UnInstallMQListener.cmd
cmd /c $loc\Integration\UnInstallFileWatcher.cmd
