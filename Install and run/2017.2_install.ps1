...
((Get-Content -path "$loc\Source\ECS\Infrastructure\Brady.Etrm.PositionInteropHostingServer64\Brady.Etrm.PositionInteropHostingServer64.vcxproj" -Raw) -replace '<WindowsTargetPlatformVersion>8.1</WindowsTargetPlatformVersion>','<WindowsTargetPlatformVersion>10.0.17134.0</WindowsTargetPlatformVersion>') | Set-Content -Path "$loc\Source\ECS\Infrastructure\Brady.Etrm.PositionInteropHostingServer64\Brady.Etrm.PositionInteropHostingServer64.vcxproj"
